...
local Theme = {
    Background = Color3.fromRGB(15,15,15),        -- fond principal GUI
    TabSelected = Color3.fromRGB(25,25,25),       -- onglet sélectionné
    Text = Color3.fromRGB(255,255,255),           -- texte titres/tabs
    OptionText = Color3.fromRGB(220,220,220),     -- texte options
    ToggleOn = Color3.fromRGB(50,50,50),          -- toggle ON
    ToggleOff = Color3.fromRGB(35,35,35),         -- toggle OFF
    OptionBackground = Color3.fromRGB(15,15,15),  -- fond option
    OptionBorder = Color3.fromRGB(40,40,40),      -- contour option
    Button = Color3.fromRGB(35,35,35),            -- bouton
    ButtonBorder = Color3.fromRGB(40,40,40)       -- contour bouton
}
