-- Moon UI Library v1.0 by AGTV (Dark / Clean update - Full Working Version)
local TweenService = game:GetService("TweenService")
local UserInputService = game:GetService("UserInputService")

-- Thème Dark complet
local Theme = {
    Background = Color3.fromRGB(0,0,0),         -- noir
    TabSelected = Color3.fromRGB(20,20,20),     -- gris très foncé pour tab sélectionnée
    Text = Color3.fromRGB(0,0,0),               -- texte noir
    ToggleOn = Color3.fromRGB(40,40,40),        -- toggle ON foncé
    ToggleOff = Color3.fromRGB(20,20,20),       -- toggle OFF plus foncé
    Button = Color3.fromRGB(0,0,0),             -- bouton noir
    ButtonBorder = Color3.fromRGB(40,40,40)     -- contour bouton légèrement plus clair
}
